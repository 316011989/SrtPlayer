...
Java_com_sls_liteplayer_pull_JniPull_srtStartup(JNIEnv *env, jclass clazz) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_sls_liteplayer_pull_JniPull_srtCleanup(JNIEnv *env, jclass clazz) {
...
Java_com_sls_liteplayer_pull_JniPull_srtOpen(
        JNIEnv *env,
...
extern "C" JNIEXPORT jint JNICALL
Java_com_sls_liteplayer_pull_JniPull_srtClose(
        JNIEnv *env,
...
Java_com_sls_liteplayer_pull_JniPull_srtRecv(
        JNIEnv *env,
        jobject /* this */, jlong srt) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_sls_liteplayer_pull_JniPull_srtGetSockState(
        JNIEnv *env,
        jobject /* this */, jlong srt) {
